...
# Change the first, third, and sixth elemnets to the value 6
...
test_temp <- c(16.550540, 26.942005, 32.591088, 8.580116, 28.003873, 28.003873, 28.542391, 20.976820, 21.173577, 21.048836, 18.769735)
...
```{r}
test_temp_mat <- matrix(c(16.550540, 26.942005, 32.591088, 8.580116, 28.003873, 28.003873, 28.542391, 20.976820, 21.173577, 21.048836, 18.769735), nrow = 2)
...
1.  Do 5 CodeWars problems in R. Share your solutions here:
    ...
    ```{r}
#1. Codewars problem FIXME: Replace all dots
    # original problem: 
  ...
  #2 Codewars problem Returning Strings
  ...
  #3 Codewars problem Remove exclamation marks
  ...
  #4 Codewars problem The Wide-Mouthed frog!
    # create a  method that takes one argument 'animal' which corresponds to the animal encountered by the frog.
    # If the animal is an alligator, return 'small'. else return 'wide'
  # My solution:
  ...
  #5 Codwars problem Remove String Spaces!
...
stairs_mario <- function(n) {
  s <- matrix("", n, n)
  s[!upper.tri(s)[,n:1]] <- 'X'
  s
}
    print(stairs_mario(10), quote = FALSE)
